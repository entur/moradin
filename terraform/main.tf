...
resource "google_service_account" "moradin_service_account" {
...
resource "google_storage_bucket_iam_member" "storage_bucket_iam_member" {
  ...
  member = "serviceAccount:${google_service_account.moradin_service_account.email}"
}

# create key for service account
resource "google_service_account_key" "service_account_key" {
  service_account_id = google_service_account.moradin_service_account.name
}
